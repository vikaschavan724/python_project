...
df.show()
df1=df.withColumn("Amount", ceil(col("Amount")/3)) #0.33,0.66,1.33,1.66
df1.show()
df3=df.withColumn("Amount", floor(col("Amount")/3)) #0.33,0.66,1.33,1.66
df3.show()
df2=df.withColumn("Amount", round(col("Amount")/3)) #0.33,0.66,1.33,1.66
df2.show()
